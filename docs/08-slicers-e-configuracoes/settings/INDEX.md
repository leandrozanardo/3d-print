...
summary: "Hub dos conceitos de configuração de fatiamento: altura de camada, largura de linha, paredes, preenchimento, temperaturas, cooling, velocidades e retração. Cada página prioriza o significado físico/processual e anota nomes típicos no Bambu Studio sem fixar caminhos de UI obsoletos. Use com presets A1 Mini e TDS do filamento."
doc_type: "hub"
domain: ["slicing", "fff"]
...
related: ["hub.slicers", "printer.bambu-lab-a1-mini"]
tags: ["hub", "settings", "slicer"]
---
...
3. Uma variável por teste; secar filamento antes de temp/retract  
