...
summary: "Hub dos conceitos de configuração de fatiamento: altura de camada, largura de linha, paredes, preenchimento, temperaturas, cooling, velocidades, retração, suportes, brim/raft/skirt, flow/PA e costura. Cada página prioriza o significado físico/processual e anota nomes típicos no Bambu Studio sem fixar caminhos de UI obsoletos. Use com presets A1 Mini e TDS do filamento."
doc_type: "hub"
domain: ["slicing", "fff"]
