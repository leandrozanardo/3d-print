...
summary: 'Formlabs Form 4B é um modelo do fabricante Formlabs registrado no catálogo
...
regions:
- US
availability_evidence: Official Formlabs Form 4B page offers Buy Now (https://formlabs.com/3d-printers/form-4b/,
  accessed 2026-08-16).
---
# Formlabs Form 4B
...
| lifecycle | `current` |
| coverage | `cataloged` |
| evidence | Official Formlabs Form 4B page offers Buy Now (https://formlabs.com/3d-printers/form-4b/, accessed 2026-08-16). |
