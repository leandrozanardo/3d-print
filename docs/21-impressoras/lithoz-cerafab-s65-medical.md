...
sources: ["source.lithoz-official-products"]
related: ["manufacturer.lithoz", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["Lithoz CeraFab S65 Medical"]
tags: ["printer", "cataloged", "lithoz"]
---
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/lithoz-official-products.md) |
| URL oficial observada | https://www.lithoz.com/en/3d-printer/overview/ |
