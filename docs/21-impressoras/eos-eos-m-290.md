...
id: printer.eos-eos-m-290
title: EOS M 290
summary: >
 EOS M 290 (EOS M 290 Series) é sistema DMLS metálico EOS listado na página oficial de
 metal printers (acesso 2026-08-16). Build volume 250 × 250 × 325 mm. Lifecycle current;
...
**Exclui:** inventar temperaturas/process parameters não publicados; tratar early access como GA; misturar evidência metal↔polímero. «printer.eos-eos-m-290»

## Especificações

| Capability | Valor observado | Fonte |
|---|---|---|
| Build volume (mm) | 250 × 250 × 325 mm ([source](../22-fontes/eos-official-metal-printers.md))| EOS metal printers compare table |
| Lasers | 1× Yb-fiber — 2× Yb-fiber (variantes / AMCM dual) ([source](../22-fontes/eos-official-metal-printers.md))| EOS metal printers compare table |
| Machine dimensions (mm) | 2500 × 1300 × 2190 — 2680 × 2120 × 2400 mm ([source](../22-fontes/eos-official-metal-printers.md))| EOS metal printers compare table |
| Weight (kg) | 1350 kg ([source](../22-fontes/eos-official-metal-printers.md))| EOS metal printers compare table |
...
- Mid-size DMLS; broad material portfolio (claim listing).
...
- Não publicado pelo fabricante em HTML público completo nesta revisão (quando aplicável): declarado em Lacunas «printer.eos-eos-m-290»

## Hardware

- Série: EOS M 290 Series
...
- Versões pinadas: lacuna sem captura datada «printer.eos-eos-m-290»

## Firmware

- Versão de firmware/controller pinada: não publicada nesta página sem captura datada do fabricante
- Atualizações: canal oficial do OEM (customer portal / release notes) «printer.eos-eos-m-290»
...
Portfólio de pós metálicos EOS / parâmetros certificados: **consultar** páginas de materiais EOS — não inventar ligas ou densidades aqui. Listagem afirma amplo portfolio na série M 290. «printer.eos-eos-m-290»
...
- Contaminação cruzada entre materiais: procedimento OEM obrigatório «printer.eos-eos-m-290»
...
- Critérios de parada: alarmes de O₂, filtro, laser, smell anômalo, fire detection «printer.eos-eos-m-290»

## Known issues

Known issues públicos pinados por serial: **não publicados** nesta listagem.

Operacional: falhas típicas de classe (recoater streaks, lack of fusion, filter loading) exigem playbooks EOS + metalurgia — não inventar root-cause aqui. «printer.eos-eos-m-290»
...
- Firmware versions
- Troubleshooting-mapped «printer.eos-eos-m-290»

## Status editorial (remediação corretiva 2026-08-16)

A página **EOS M 290 Series** (`printer.eos-eos-m-290`) foi reclassificada de `documented` para `cataloged` porque, nesta execução, a única evidência pinada era listagem genérica do fabricante (`source.eos-official-metal-printers`, tipicamente `manufacturer-product-listing`). Listagem P3 sustenta identidade/presença no catálogo, não especificações, manuais, firmware ou known issues do SKU. Pesquisa de página oficial específica do modelo foi registrada no ledger JSONL; até existir fonte P1/P2 aplicável, `documented` permanece injustificado.

<!-- editorial-fingerprint:printer.eos-eos-m-290:eos-eos-m-290.md -->

### Nota de especificidade — EOS M 290

Este bloco existe para impedir documentação falsa-específica: o conteúdo operacional e as lacunas abaixo referem-se exclusivamente a **EOS M 290** (`printer.eos-eos-m-290`, fabricante `eos`), não a irmãos de linha. Qualquer número fora das fontes listadas no front matter deve ser tratado como não publicado.
