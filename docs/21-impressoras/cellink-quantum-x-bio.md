...
sources: ["source.cellink-official-products"]
related: ["manufacturer.cellink", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["CELLINK (BICO) Quantum X bio"]
tags: ["printer", "cataloged", "cellink"]
---
# CELLINK (BICO) Quantum X bio

Hub: [Impressoras](INDEX.md) · Fabricante: [CELLINK (BICO)](manufacturer-cellink.md) · Catálogo: [_meta/catalogo-global.md](_meta/catalogo-global.md)
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/cellink-official-products.md) |
| URL oficial observada | https://www.cellink.com/bioprinting/ |
