---
id: printer.elegoo-neptune-4
title: Elegoo Neptune 4
summary: ELEGOO Neptune 4 é FFF open-frame Klipper 225×225×265 mm, listada na loja
  oficial US em 2026-08-16.
doc_type: printer
domain:
- printers
- fff
...
model_name: Neptune 4
family_status: neptune-4-series
lifecycle_observed_at: '2026-08-16'
regions:
- US
availability_evidence: Listed for purchase on official ELEGOO US store https://us.elegoo.com/products/elegoo-neptune-4-fdm-3d-printer
  (accessed 2026-08-16).
---
# Elegoo Neptune 4
...
Documentação de **Elegoo Neptune 4** distingue claims sustentados pela listagem oficial de parâmetros não publicados.
...
| Modelo | Neptune 4 |
| Título canônico | Elegoo Neptune 4 |
| Família | neptune-4-series |
| Aliases EN | Elegoo Neptune 4, ELEGOO Neptune 4, Neptune 4 |
...
| nome observado | Neptune 4 / Elegoo Neptune 4 |
...
**Inclui:** identidade de **Elegoo Neptune 4**, evidência de lifecycle acima, classificação material-extrusion/fff, procedimentos editoriais e lacunas específicas do SKU.
...
Mapa de manuais específicos de **Neptune 4**: não publicado / não localizado na superfície citada em 2026-08-16. Próximo passo: portal de suporte elegoo + PDF por SKU.

## Hardware

Hardware detalhado (eixos, hotend/óptica/energia, sensores, revisões) de **Elegoo Neptune 4**: **não publicado** na evidência de listagem. Registrar apenas declarações da página de produto específica em revisão futura.

## Software

Para **Neptune 4**, não assumir stack de software de outro produto elegoo.

## Firmware

Atualização de firmware de **Neptune 4** exige fonte OEM dedicada antes de qualquer claim de versão.

## Slicer

Usar perfis oficiais elegoo quando existirem para **Neptune 4**. Não colar perfil de irmão de linha sem revisão.

Calibração típica da classe: nivelamento/Z-offset, flow e temperaturas por material — não copiar presets de outro modelo.

## Materiais

Compatibilidade Ideal/Capable/Not Recommended de **Neptune 4**: **não publicada** na listagem genérica citada. Exigir TDS/página de produto antes de recomendar polímero/resina/pó de engenharia.

## Manutenção

Para **Elegoo Neptune 4**: verificar path de filamento, bico, mesa/adesão e lubrificação de eixos conforme manual OEM. Intervalos/torque específicos: somente manual oficial.

## Segurança

Riscos de classe para **Neptune 4**: superfícies quentes, partes móveis, risco de blob/incêndio residual se impressão desacompanhada sem monitoramento.
...
Pesquisa de recall/service bulletin para **Neptune 4** (elegoo) não retornou evidência suficiente para promover issue conhecida.

Classificação: inventário vazio consciente (≠ prova de ausência de problemas de campo).

## Fontes

- [source.elegoo-neptune-4](../22-fontes/elegoo-neptune-4.md)
...
- Firmware/release notes pinados para **Neptune 4**
- Matriz de materiais Ideal/Capable/Not Recommended publicada para **Neptune 4**
- Troubleshooting oficial por sintoma para **Elegoo Neptune 4**
