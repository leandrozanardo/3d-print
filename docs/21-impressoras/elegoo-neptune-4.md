...
summary: ELEGOO Neptune 4 é FFF open-frame Klipper 225×225×265 mm, listada na loja oficial US em 2026-08-16.
doc_type: printer
domain:
- printers
- fff
...
| evidence | Listed for purchase on official ELEGOO US store https://us.elegoo.com/products/elegoo-neptune-4-fdm-3d-printer (accessed 2026-08-16). |
| URL produto | https://us.elegoo.com/products/elegoo-neptune-4-fdm-3d-printer |
...
|---|---|---|
| Build volume | 225 × 225 × 265 mm | loja US (oficial) |
| Technology label | FDM (Fused Deposition Modeling) | série Neptune 4 |
...
- Família Neptune 4 bed-slinger com firmware Klipper (série)

## Manuais

- Página produto/manual links: https://us.elegoo.com/products/elegoo-neptune-4-fdm-3d-printer
- Service manual completo pinado: lacuna se não linkado na evidência

## Hardware

- Open-frame; dual lead screw típico da série
...
- Seguir página do modelo; não copiar lista do Neptune 4 Pro sem checagem
...
- Cells de nozzle/bed temps específicas do SKU base: confirmar no bloco Specification da página
...
- URL oficial: https://us.elegoo.com/products/elegoo-neptune-4-fdm-3d-printer
