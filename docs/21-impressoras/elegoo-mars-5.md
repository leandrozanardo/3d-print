...
title: Elegoo Mars 5
summary: ELEGOO Mars 5 é MSLA/LCD resin (6.6" 4K) volume ~143.43×89.6×150 mm, listada
...
regions:
- US
availability_evidence: Listed for purchase on official ELEGOO US store https://us.elegoo.com/products/mars-5-4k-6-6inch-monochrome-lcd-resin-3d-printer
  (accessed 2026-08-16).
---
# Elegoo Mars 5
...
Para **Elegoo Mars 5**, o foco operacional desta base é identidade + lifecycle observado + classe vat-photopolymerization/msla.
...
| Modelo | Mars 5 |
| Título canônico | Elegoo Mars 5 |
| Família | mars-5-series |
| Aliases EN | Elegoo Mars 5, ELEGOO Mars 5, Mars 5 |
...
| nome observado | Mars 5 / Elegoo Mars 5 |
...
**Inclui:** identidade de **Elegoo Mars 5**, evidência de lifecycle acima, classificação vat-photopolymerization/msla, procedimentos editoriais e lacunas específicas do SKU.
...
Mapa de manuais específicos de **Mars 5**: não publicado / não localizado na superfície citada em 2026-08-16. Próximo passo: portal de suporte elegoo + PDF por SKU.

## Hardware

Hardware detalhado (eixos, hotend/óptica/energia, sensores, revisões) de **Elegoo Mars 5**: **não publicado** na evidência de listagem. Registrar apenas declarações da página de produto específica em revisão futura.

## Software

Software declarado para **Elegoo Mars 5**: seguir portal OEM; versão pinada: não publicada nesta revisão.

## Firmware

Release notes específicas de **Elegoo Mars 5**: não localizadas na superfície de listagem.

## Slicer

Usar perfis oficiais elegoo quando existirem para **Mars 5**. Não colar perfil de irmão de linha sem revisão.

Calibração típica da classe: exposição, lift speeds e suporte — seguir resin settings oficiais quando existirem.

## Materiais

Compatibilidade Ideal/Capable/Not Recommended de **Mars 5**: **não publicada** na listagem genérica citada. Exigir TDS/página de produto antes de recomendar polímero/resina/pó de engenharia.

## Manutenção

Para **Elegoo Mars 5**: cuba/FEP ou membrana, placa de construção, filtragem de resina e limpeza de óptica conforme OEM. Intervalos/torque específicos: somente manual oficial.

## Segurança

Riscos de classe para **Mars 5**: PPE para resina não curada, ventilação, descarte conforme SDS; UV/LED conforme classe do equipamento.
...
Inventário de falhas de **Elegoo Mars 5** permanece vazio consciente até captura de boletim/wiki OEM datada.
...
- Troubleshooting oficial por sintoma para **Elegoo Mars 5**
- Revisões de hardware / changelogs de **Mars 5**
- Página de produto dedicada ao SKU **Mars 5** com tabela numérica completa
