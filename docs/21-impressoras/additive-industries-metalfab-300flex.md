...
summary: 'Additive Industries MetalFab 300Flex é um modelo do fabricante Additive
  Industries registrado no catálogo fix-my-print (snapshot market-snapshot-2026-08-16-census).
