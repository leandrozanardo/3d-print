...
A ficha **Voxelab Aquila C2** (voxelab) prioriza evidência de catálogo e lacunas explícitas de datasheet numérico.
...
| Modelo | Voxelab Aquila C2 |
| Título canônico | Voxelab Aquila C2 |
| Família | unknown |
| Aliases EN | Voxelab Aquila C2, Voxelab Aquila C2 |
...
| nome observado | Voxelab Aquila C2 / Voxelab Aquila C2 |
...
**Inclui:** identidade de **Voxelab Aquila C2**, evidência de lifecycle acima, classificação material-extrusion/fff, procedimentos editoriais e lacunas específicas do SKU.
...
Valores de volume, temperatura e velocidade para **Voxelab Aquila C2**: **não publicados pelo fabricante** na evidência de listagem citada em 2026-08-16.
...
Mapa de manuais específicos de **Voxelab Aquila C2**: não publicado / não localizado na superfície citada em 2026-08-16. Próximo passo: portal de suporte voxelab + PDF por SKU.

## Hardware

Hardware detalhado (eixos, hotend/óptica/energia, sensores, revisões) de **Voxelab Aquila C2**: **não publicado** na evidência de listagem. Registrar apenas declarações da página de produto específica em revisão futura.

## Software

Slicer/firmware do ecossistema voxelab aplicam-se somente após confirmar perfil/SKU **Voxelab Aquila C2**.

## Firmware

Canal de firmware de **Voxelab Aquila C2**: não pinado (2026-08-16).

## Slicer

Usar perfis oficiais voxelab quando existirem para **Voxelab Aquila C2**. Não colar perfil de irmão de linha sem revisão.

Calibração típica da classe: nivelamento/Z-offset, flow e temperaturas por material — não copiar presets de outro modelo.

## Materiais

Compatibilidade Ideal/Capable/Not Recommended de **Voxelab Aquila C2**: **não publicada** na listagem genérica citada. Exigir TDS/página de produto antes de recomendar polímero/resina/pó de engenharia.

## Manutenção

Para **Voxelab Aquila C2**: verificar path de filamento, bico, mesa/adesão e lubrificação de eixos conforme manual OEM. Intervalos/torque específicos: somente manual oficial.

## Segurança

Riscos de classe para **Voxelab Aquila C2**: superfícies quentes, partes móveis, risco de blob/incêndio residual se impressão desacompanhada sem monitoramento.
...
Nenhum known issue classificado para **Voxelab Aquila C2** nesta passagem: sem confirmação oficial, reprodução controlada ou tríade independente.
...
- Matriz de materiais Ideal/Capable/Not Recommended publicada para **Voxelab Aquila C2**
- Troubleshooting oficial por sintoma para **Voxelab Aquila C2**
- Revisões de hardware / changelogs de **Voxelab Aquila C2**
