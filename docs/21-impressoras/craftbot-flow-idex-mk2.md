...
sources: ["source.craftbot-official-products"]
related: ["manufacturer.craftbot", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["Craftbot Flow IDEX MK 2"]
tags: ["printer", "cataloged", "craftbot"]
---
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/craftbot-official-products.md) |
| URL oficial observada | https://craftbot.com/products |
