...
title: HP MJF 1200
summary: HP Multi Jet Fusion 1200 é sistema MJF compacto 12 L (320×165×230 mm)
  em early access na product page oficial US. GA planejada para early 2027 —
  lifecycle announced (não current). Coverage documented com claims somente da
  product page (acesso 2026-08-16).
doc_type: printer
domain:
- printers
- powder-bed-fusion
