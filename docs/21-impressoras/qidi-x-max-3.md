...
sources: ["source.qidi-official-products"]
related: ["manufacturer.qidi", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["QIDI X-Max 3"]
tags: ["printer", "cataloged", "qidi"]
---
# QIDI X-Max 3
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/qidi-official-products.md) |
| URL oficial observada | https://qidi3d.com/collections/3d-printers |
