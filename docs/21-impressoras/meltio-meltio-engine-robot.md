...
related: ["manufacturer.meltio", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["Meltio Meltio Engine Robot"]
tags: ["printer", "cataloged", "meltio"]
---
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/meltio-official-products.md) |
| URL oficial observada | https://meltio3d.com/ |
