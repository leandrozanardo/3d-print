...
related: ["manufacturer.hp", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["HP Metal Jet S100"]
tags: ["printer", "cataloged", "hp"]
---
# HP Metal Jet S100
...
|---|---|
| Fabricante | HP |
| Modelo | HP Metal Jet S100 |
| Lifecycle (snapshot 2026-08-16) | `current` |
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/hp-official-products.md) |
| URL oficial observada | https://www.hp.com/us-en/printers/3d-printers/products.html |
