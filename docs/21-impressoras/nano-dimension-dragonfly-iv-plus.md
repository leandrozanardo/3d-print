---
id: printer.nano-dimension-dragonfly-iv-plus
...
applies_to:
- nano-dimension
- nano-dimension-dragonfly-iv-plus
not_for:
...
Datasheet numérico de **Nano Dimension DragonFly IV+** não foi extraído da URL de listagem; registrar apenas o que a página de produto específica publicar.
...
Software declarado para **Nano Dimension DragonFly IV+**: seguir portal OEM; versão pinada: não publicada nesta revisão.

## Firmware

Release notes específicas de **Nano Dimension DragonFly IV+**: não localizadas na superfície de listagem.
...
Inventário de falhas de **Nano Dimension DragonFly IV+** permanece vazio consciente até captura de boletim/wiki OEM datada.
