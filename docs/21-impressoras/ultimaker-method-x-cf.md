...
sources: ["source.ultimaker-official-products"]
related: ["manufacturer.ultimaker", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["UltiMaker Method X Carbon Fiber"]
tags: ["printer", "cataloged", "ultimaker"]
---
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/ultimaker-official-products.md) |
| URL oficial observada | https://ultimaker.com/3d-printers/ |
