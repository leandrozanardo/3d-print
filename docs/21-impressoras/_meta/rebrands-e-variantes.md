...
summary: "Registro de rebrands, white-labels e variantes regionais/SKU que não devem gerar modelos duplicados sem diferença real de hardware, processo ou capability."
doc_type: "catalog"
domain: ["printers", "meta"]
technology: []
process: []
applies_to: ["catalog-maintainers"]
not_for: ["unverified-equivalence-claims"]
...
sources: []
related: ["meta.printer-inclusion-criteria", "meta.printer-exclusions"]
prerequisites: ["meta.printer-inclusion-criteria"]
supersedes: []
aliases_pt_br: ["rebrands impressoras"]
aliases_en: ["printer rebrands and variants"]
tags: ["rebrand", "sku", "catalog"]
---
