...
sources: ["source.wasp-official-products"]
related: ["manufacturer.wasp", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["WASP Crane WASP"]
tags: ["printer", "cataloged", "wasp"]
---
# WASP Crane WASP
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/wasp-official-products.md) |
| URL oficial observada | https://www.3dwasp.com/ |
