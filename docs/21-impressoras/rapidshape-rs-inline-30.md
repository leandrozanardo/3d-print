...
sources: ["source.rapidshape-official-products"]
related: ["manufacturer.rapidshape", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["Rapid Shape RS inline 3.0"]
tags: ["printer", "cataloged", "rapidshape"]
---
# Rapid Shape RS inline 3.0

Hub: [Impressoras](INDEX.md) · Fabricante: [Rapid Shape](manufacturer-rapidshape.md) · Catálogo: [_meta/catalogo-global.md](_meta/catalogo-global.md)
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/rapidshape-official-products.md) |
| URL oficial observada | https://www.rapidshape.de/ |
