...
sources: ["source.prusa-research-official-products"]
related: ["manufacturer.prusa-research", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["Prusa Research Prusa CORE One+ (Gen 2)"]
tags: ["printer", "cataloged", "prusa-research"]
---
...
| Modelo | Prusa Research Prusa CORE One+ (Gen 2) |
| Lifecycle (snapshot 2026-08-16) | `current` |
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/prusa-research-official-products.md) |
| URL oficial observada | https://www.prusa3d.com/product/prusa-core-one-2/ |
