...
sources: ["source.makerbot-official-products"]
related: ["manufacturer.makerbot", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["MakerBot Sketch Standard"]
tags: ["printer", "cataloged", "makerbot"]
---
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/makerbot-official-products.md) |
| URL oficial observada | https://www.makerbot.com/3d-printers/ |
