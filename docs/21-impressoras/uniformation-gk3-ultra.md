...
related: ["manufacturer.uniformation", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["Uniformation GK3 Ultra"]
tags: ["printer", "cataloged", "uniformation"]
---
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/uniformation-official-products.md) |
| URL oficial observada | https://uniformation3d.com/collections/all-3d-printer |
...
- part-of → fabricante `uniformation`
