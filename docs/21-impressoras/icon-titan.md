...
sources: ["source.icon-official-products"]
related: ["manufacturer.icon", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["ICON Titan"]
tags: ["printer", "cataloged", "icon"]
---
# ICON Titan
...
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/icon-official-products.md) |
| URL oficial observada | https://www.iconbuild.com/technology |
