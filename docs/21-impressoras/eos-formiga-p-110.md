...
summary: >
 EOS FORMIGA P 110 (FORMIGA P 110 Series) é sistema SLS polímero EOS listado na página
 oficial de polymer printers (acesso 2026-08-16). Build volume 200 × 250 × 330 mm.
...
- sls
manufacturer_id: eos
model_name: FORMIGA P 110 Series
...
**Exclui:** inventar temperaturas/process parameters não publicados; tratar early access como GA; misturar evidência metal↔polímero. «printer.eos-formiga-p-110»

## Especificações

| Capability | Valor observado | Fonte |
|---|---|---|
| Build volume (mm) | 200 × 250 × 330 mm ([source](../22-fontes/eos-official-products.md))| EOS polymer printers compare table |
| Lasers | 1× CO₂ ([source](../22-fontes/eos-official-products.md))| EOS polymer printers compare table |
| Machine dimensions (mm) | 1320 × 1067 × 2204 mm ([source](../22-fontes/eos-official-products.md))| EOS polymer printers compare table |
| Weight (kg) | 610 kg ([source](../22-fontes/eos-official-products.md))| EOS polymer printers compare table |
...
- Compact SLS / small footprint (claim listing).
...
- Não publicado pelo fabricante em HTML público completo nesta revisão (quando aplicável): declarado em Lacunas «printer.eos-formiga-p-110»

## Hardware

- Série: FORMIGA P 110 Series
...
- Atualizações: canal oficial do OEM (customer portal / release notes) «printer.eos-formiga-p-110»
...
Materiais poliméricos validados EOS: consultar portfólio oficial — não inventar PA/TPU/etc. como compatíveis sem ficha EOS. INTEGRA P 450: claim de processamento até 300 °C na página. «printer.eos-formiga-p-110»

## Manutenção

### Classe polymer SLS
- Sieving/refresh de pó, limpeza de câmara, troca de filtros, calibração térmica: manuais EOS
- Refresh ratios: seguir procedimento do material — não inventar percentuais «printer.eos-formiga-p-110»
...
- Critérios de parada: alarmes térmicos, odor de queima, falha de recoater «printer.eos-formiga-p-110»
...
A página **FORMIGA P 110 Series** (`printer.eos-formiga-p-110`) foi reclassificada de `documented` para `cataloged` porque, nesta execução, a única evidência pinada era listagem genérica do fabricante (`source.eos-official-products`, tipicamente `manufacturer-product-listing`). Listagem P3 sustenta identidade/presença no catálogo, não especificações, manuais, firmware ou known issues do SKU. Pesquisa de página oficial específica do modelo foi registrada no ledger JSONL; até existir fonte P1/P2 aplicável, `documented` permanece injustificado.

<!-- editorial-fingerprint:printer.eos-formiga-p-110:eos-formiga-p-110.md -->

### Nota de especificidade — EOS FORMIGA P 110

Este bloco existe para impedir documentação falsa-específica: o conteúdo operacional e as lacunas abaixo referem-se exclusivamente a **EOS FORMIGA P 110** (`printer.eos-formiga-p-110`, fabricante `eos`), não a irmãos de linha. Qualquer número fora das fontes listadas no front matter deve ser tratado como não publicado.
