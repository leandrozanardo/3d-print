...
summary: 'Formlabs Form 4BL é um modelo do fabricante Formlabs registrado no catálogo
...
regions:
- US
availability_evidence: Official Formlabs Form 4BL page offers Buy Now (https://formlabs.com/3d-printers/form-4bl/,
  accessed 2026-08-16).
---
# Formlabs Form 4BL
...
| lifecycle | `current` |
| coverage | `cataloged` |
| evidence | Official Formlabs Form 4BL page offers Buy Now (https://formlabs.com/3d-printers/form-4bl/, accessed 2026-08-16). |
