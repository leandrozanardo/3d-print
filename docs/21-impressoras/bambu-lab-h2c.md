...
id: printer.bambu-lab-h2c
title: Bambu Lab H2C
summary: Bambu Lab H2C listada para compra na loja oficial Bambu Lab US (acesso 2026-08-16).
...
availability_evidence: Listed for immediate purchase on official Bambu Lab US store
  https://us.store.bambulab.com/products/h2c and/or collection https://us.store.bambulab.com/collections/3d-printer
  (accessed 2026-08-16).
---
...
| URL exata | https://us.store.bambulab.com/products/h2c |
...
**Exclui:** inventar firmware pinado, transferir presets de outra máquina Bambu sem adaptação, promover claims de marketing não observados. «printer.bambu-lab-h2c»
...
Valores observados na evidência citada (loja US / listagem), acesso 2026-08-16. Capability does not equal process suitability for every filament. «printer.bambu-lab-h2c»
...
| URL produto | https://us.store.bambulab.com/products/h2c ([source](../22-fontes/bambu-lab-official-products.md))| loja US |
...
- Detalhes de arquitetura (CoreXY/bed-slinger/dual): confirmar na página de produto/TDS — não inventados aqui «printer.bambu-lab-h2c»

## Manuais

- Wiki / support Bambu Lab (mapear por sintoma)
- Página de produto da loja US (evidência primária desta revisão)
- Service manual público completo: não publicado pelo fabricante nesta revisão (lacuna consciente) «printer.bambu-lab-h2c»

## Hardware

- Hardware detalhado: ver página do produto; não inventar contagem de extrusores/lasers sem extração
- Revisão de hardware pinada por serial: não publicada pelo fabricante nesta revisão «printer.bambu-lab-h2c»
...
- Não inventar versão de firmware sem captura datada «printer.bambu-lab-h2c»

## Slicer

- Primário: [Bambu Studio](../08-slicers-e-configuracoes/bambu-studio.md) (`slicer.bambu-studio`)
- Regra: começar do preset do **modelo**, não colar perfil de outra família sem revisão «printer.bambu-lab-h2c»

## Materiais

Materiais Ideal/Capable: **não publicados pelo fabricante de forma pinável nesta revisão** além do posicionamento genérico da collection (PLA/PETG vs engineering enclosed). Consultar página do modelo / TDS oficial antes de claims. «printer.bambu-lab-h2c»
...
- Validar cupom de primeira camada antes de peças longas «printer.bambu-lab-h2c»
...
- Seguir wiki/support Bambu do modelo quando existir página dedicada «printer.bambu-lab-h2c»
...
- Critérios de parada: fumaça, odor anômalo intenso, blob no hotend, colisão repetida, overheat reportado pelo firmware «printer.bambu-lab-h2c»
...
- Loja US: https://us.store.bambulab.com/products/h2c
...
A página **H2C** (`printer.bambu-lab-h2c`) foi reclassificada de `documented` para `cataloged` porque, nesta execução, a única evidência pinada era listagem genérica do fabricante (`source.bambu-lab-official-products`, tipicamente `manufacturer-product-listing`). Listagem P3 sustenta identidade/presença no catálogo, não especificações, manuais, firmware ou known issues do SKU. Pesquisa de página oficial específica do modelo foi registrada no ledger JSONL; até existir fonte P1/P2 aplicável, `documented` permanece injustificado.

<!-- editorial-fingerprint:printer.bambu-lab-h2c:bambu-lab-h2c.md -->

### Nota de especificidade — Bambu Lab H2C

Este bloco existe para impedir documentação falsa-específica: o conteúdo operacional e as lacunas abaixo referem-se exclusivamente a **Bambu Lab H2C** (`printer.bambu-lab-h2c`, fabricante `bambu-lab`), não a irmãos de linha. Qualquer número fora das fontes listadas no front matter deve ser tratado como não publicado.
