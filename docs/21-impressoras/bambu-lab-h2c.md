...
supersedes: []
aliases_pt_br: []
aliases_en: ["Bambu Lab H2C"]
tags: ["printer", "cataloged", "bambu-lab"]
---
# Bambu Lab H2C

Hub: [Impressoras](INDEX.md) · Fabricante: [Bambu Lab](manufacturer-bambu-lab.md) · Catálogo: [_meta/catalogo-global.md](_meta/catalogo-global.md)
...
| Modelo | Bambu Lab H2C |
| Lifecycle (snapshot 2026-08-16) | `current` |
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/bambu-lab-official-products.md) |
| URL oficial observada | https://us.store.bambulab.com/collections/3d-printer |
