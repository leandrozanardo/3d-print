...
sources: ["source.impossible-objects-official-products"]
related: ["manufacturer.impossible-objects", "hub.impressoras", "meta.printer-global-catalog"]
prerequisites: ["hub.impressoras"]
supersedes: []
aliases_pt_br: []
aliases_en: ["Impossible Objects CBAM 25"]
tags: ["printer", "cataloged", "impossible-objects"]
---
...
| Campo | Valor |
|---|---|
| Fabricante | Impossible Objects |
| Modelo | Impossible Objects CBAM 25 |
| Lifecycle (snapshot 2026-08-16) | `current` |
| coverage_level | `cataloged` |
| Fonte de descoberta | [fonte](../22-fontes/impossible-objects-official-products.md) |
| URL oficial observada | https://impossible-objects.com/ |
...
- part-of → fabricante `impossible-objects`
