---
id: "hub.maquinas"
title: "Máquinas e arquiteturas"
summary: "Cinemáticas, envelopes, câmaras e classes de máquina do desktop ao industrial. Hub de navegação; a cobertura profunda depende da matriz em _meta/cobertura.md."
doc_type: "hub"
domain: ["hub"]
technology: []
process: []
...
supersedes: []
aliases_pt_br: ["Máquinas e arquiteturas"]
aliases_en: []
tags: ["hub"]
---

# Máquinas e arquiteturas

## Escopo

Cinemáticas, envelopes, câmaras e classes de máquina do desktop ao industrial.
...
| Página | ID | Status |
|---|---|---|
| [Cinemática bed-slinger](cinematica-bed-slinger.md) | `kinematics.bed-slinger` | draft |
