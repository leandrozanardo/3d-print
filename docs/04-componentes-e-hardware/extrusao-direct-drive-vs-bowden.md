...
**Regra desta base:** na A1 Mini, trate retract/PA como valores de **direct drive**. Não copie retrações longas “clássicas de Bowden” sem validar no seu direct drive (orientação; sem fonte pinada).
