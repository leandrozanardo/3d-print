...
summary: "Registro da página oficial de especificações técnicas do A1 mini: volume 180³ mm, nozzle 0,4 mm incluso, bed max 80 °C, materiais recomendados e não recomendados pelo fabricante."
doc_type: "source"
domain: ["sources"]
...
| tipo | manufacturer documentation |
