...
summary: "Firmware, G-code, hosts remotos e limites seguros de automação. Hub de navegação; a cobertura profunda depende da matriz em _meta/cobertura.md."
doc_type: "hub"
domain: ["hub"]
technology: []
process: []
...
supersedes: []
aliases_pt_br: ["Software, firmware e automação"]
aliases_en: []
tags: ["hub"]
---
