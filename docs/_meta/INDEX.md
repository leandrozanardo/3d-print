...
summary: 'Portal da camada _meta: inventário, arquitetura, ontologia, políticas editoriais,
  cobertura, migração e protocolo de continuação da wiki de manufatura aditiva.'
doc_type: hub
domain:
- meta
- governance
