...
id: "hub.calibracao"
title: "Calibração"
summary: "Procedimentos, cupons, ordem de testes e validade temporal. Hub de navegação; a cobertura profunda depende da matriz em _meta/cobertura.md."
doc_type: "hub"
domain: ["hub"]
technology: []
process: []
...
Procedimentos, cupons, ordem de testes e validade temporal.
...
| Página | ID | Status |
|---|---|---|
| [Ordem de calibração FFF](ordem-de-calibracao-fff.md) | `cal.fff-order` | draft |
